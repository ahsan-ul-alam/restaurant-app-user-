...
// ---------------------------------------------------------
// 🔔 Local Notifications plugin (আগের মতোই)
final FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin =
FlutterLocalNotificationsPlugin();

// project_number == messagingSenderId
const String _firebaseProjectId = 'ravintolashams';
const String _firebaseMessagingSenderId = '108605700794';
const String _firebaseApiKey = 'AIzaSyCDOtgHwKRX7KnEtULg8bhzTuqYxZ_xx6s';

const String _firebaseWebAppId = '1:108605700794:web:CHANGE_ME';

const String _firebaseAndroidAppIdFallback ='1:108605700794:android:37bb8eef1112932c74a083';
...
Future<void> main() async {
  ...
  // Crashlytics থাকলে এখানে কনফিগ দিতে পারো (কমেন্টেড ছিল)

  DeepLinkBody? linkBody;

  // ---------------- Firebase Initialize -----------------
  // ✅ বিকল্প–১ (Recommended on Android/iOS): android/ios এ json/plist থাকলে options ছাড়াই:
  if (GetPlatform.isWeb) {
    // Web অবশ্যই options লাগে
    await Firebase.initializeApp(
      options: FirebaseOptions(
        apiKey: _firebaseApiKey,
        appId: _firebaseWebAppId, // <-- Console থেকে ঠিক appId বসাও
        messagingSenderId: _firebaseMessagingSenderId,
        projectId: _firebaseProjectId,
      ),
    );
  } else {
    // Android/iOS এ google-services.json / GoogleService-Info.plist থাকলে সরাসরি:
    await Firebase.initializeApp();

    // যদি চাও "force options" করতে (কিছু ক্ষেত্রে multi-app/setup), তাহলে উপরের লাইনটা কমেন্ট করে নিচেরটা ইউজ করো:
    // if (GetPlatform.isAndroid) {
    //   await Firebase.initializeApp(
    //     options: FirebaseOptions(
    //       apiKey: _firebaseApiKey,
    //       appId: _firebaseAndroidAppIdFallback,
    //       messagingSenderId: _firebaseMessagingSenderId,
    //       projectId: _firebaseProjectId,
    //     ),
    //   );
  ...
  // 🔔 FCM cold-start notification ধরার জন্য
