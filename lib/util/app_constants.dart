...
class AppConstants {
  static const String appName = 'Ravintola Shams';
  static const double appVersion = 8.4; ///Flutter SDK: 3.35.2

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const String webHostedUrl = 'https://shams.restaurant';
  static const bool useReactWebsite = false;

  static const String baseUrl = 'https://shams.restaurant';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.finnish, languageName: 'Finnish', countryCode: 'FI', languageCode: 'fi'),
  ];
